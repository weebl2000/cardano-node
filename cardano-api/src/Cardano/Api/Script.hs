...
toShelleyScript (ScriptInEra langInEra (SimpleScript SimpleScriptV1 script)) =
    case langInEra of
      ...
      SimpleScriptV1InAlonzo  -> Alonzo.NativeScript $ toAllegraTimelock script
...
toShelleyScript (ScriptInEra langInEra (SimpleScript SimpleScriptV2 script)) =
    case langInEra of
      ...
      SimpleScriptV2InAlonzo  -> Alonzo.NativeScript $ toAllegraTimelock script

toShelleyScript (ScriptInEra langInEra (PlutusScript PlutusScriptV1 _script)) =
    case langInEra of
      PlutusScriptV1InAlonzo  -> Alonzo.PlutusScript
