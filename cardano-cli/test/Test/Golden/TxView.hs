...
import           Test.Golden.Diff (diffVsFile)
...
golden_view_shelley =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    diffVsFile result "test/data/golden/shelley/transaction-view.out"
...
golden_view_allegra =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    diffVsFile result "test/data/golden/allegra/transaction-view.out"
...
golden_view_mary =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    diffVsFile result "test/data/golden/mary/transaction-view.out"
